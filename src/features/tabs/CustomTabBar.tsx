...
const CustomTabBar: FC<BottomTabBarProps> = (props) => {
    ...
    const animatedStyle = useAnimatedStyle(() => {
        return {
            transform: [
                {
                    translateY: scrollY === 1 ? withTiming(100, { duration: 300 }) : withTiming(0, { duration: 300 }),
                },
            ],
        }
    })
    ...
    return (
        <>
            ...
            >
                ...
                <Animated.View
                    style={[styles.slidingIndicator, indicatorStyle, {
                        backgroundColor: isLiveTabFocused ? "#fff" : !isVegMode ? Colors.active : Colors.primary
                    }]} />
                <TouchableOpacity style={styles.blinkitLogoContainer} activeOpacity={0.9}
