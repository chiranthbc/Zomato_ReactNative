        ...
        <Animated.View style={[opacityFadingStyles]}>
            ...
            <View style={styles.flexRowBetween}>
                <View style={styles.flexRowGap}>
                    <Icon name='map-marker' color={textColor} iconFamily='MaterialCommuntiyIcons' size={32} />
                    <View>
                        <TouchableOpacity style={styles.flexRow}>
                            <CustomText variant='h5' color={textColor} fontFamily='Okra-Bold'>
                                Indiranagr, Bangalore
                            </CustomText>
                            <Icon name='chevron-down' color={textColor} iconFamily='MaterialCommuntiyIcons' size={18} />
                        </TouchableOpacity>
                        <CustomText color={textColor} fontFamily='Okra-Medium' >Nelamangala, Karnataka</CustomText>
                    </View>
                </View>
                <View style={styles.flexRowGap}>
                    ...
                    <TouchableOpacity style={styles.profileAvatar}>
                        ...
                        {/* <Image source={require('@assets/images/icons/translation.jpg')} style={styles.profileImage} /> */}
                    </TouchableOpacity>
                </View>
            </View>
        </Animated.View>
